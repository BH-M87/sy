...
class VoteService extends BaseService
{
    ...
    public function crontab()
    {
        ...
        $view_num = intval($vote_num * 1.2);
        //VtActivityView::find()->where(['activity_code' => 'Block'])->count() + 100000;
        $join_num = intval($vote_num * 0.936);
        //VtVote::find()->select('count(DISTINCT mobile)')->where(['activity_id' => 2])->scalar();
