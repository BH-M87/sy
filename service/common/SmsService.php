...
use Yii;
use app\common\core\Curl;
use app\modules\property\models\PsSmsHistory;
...
Class SmsService extends BaseService
{
    ...
    private $templates = [
        ...
        49 => [
            'id' => 7,
            'captcha' => 1,
            'content' => '您正在注册邻易联物业管理系统，验证码为{key0}，有效期10分钟。请填写验证码完成注册。'
        ],
        50 => [
            'id' => 8,
            'content' => '您的物业管理系统--邻易联账号{key0}还有{key1}就到期了，为了不影响您的正常业务，请及时登录 https://alipay.elive99.com 续时'
        ],
        51 => [
            'id' => 9,
            'content' => '您的物业管理系统--邻易联账号{key0}已到期，为了不影响您的正常业务，请及时登录 https://alipay.elive99.com 续时'
        ],
        52 => [
            'id' => 10,
            'content' => '您已购买邻易联物业管理系统，小区数量{key0}个，有效期{key1}，到期时间：{key3}。'
        ],
        53 => [
            'id' => 11,
            'content' => '您已购买邻易联物业管理系统，小区数量{key0}个，购买时长{key1}，到期时间：{key2}。'
        ],
        54 => [
        	'id' => 12,
        	'content' => '您的邻易联物管系统权限已开通，账号{key0}，初始密码{key1}。请立即登陆领取使用：https://t.zje.com/Dm98CC'
        ]
    ];
