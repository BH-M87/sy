...
<div class="col-md-8">
    <div class="box box-info">
        <form class="form-horizontal" id="agent-add-form" method="post" action = "/backend/application-update">
            ...
            <div class="box-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <select id="company-select" class="form-control select2" name="corp_id">
                            ...
                            ?>
                                <?php
                                    if($model['corp_id'] == $v['corp_id']){
                                ?>
                                    <option value= "<?= $v['corp_id']?>" selected><?= $v['name']?></option>
                                <?php
                                    }else{
                                ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="agent_id" name="agent_id"  value="<?= $model['agent_id']?>" placeholder="agent_id">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">app_key</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="app_key" name="app_key"  value="<?= $model['app_key']?>" placeholder="app_key">
                    </div>
                </div>
                <div class="form-group">
                    <label for="inputPassword3" class="col-sm-2 control-label">app_secret</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="app_secret" name="app_secret"  value="<?= $model['app_secret']?>" placeholder="app_secret">
                    </div>
                </div>
            </div>
