...
class Lunar
{
  ...
  * @param date 公历-日
  */
  function convertSolarToLunar($_date)
  {
  ...
  function getFestival($today, $nl_info = false,$config = 1)
  {
    if($config == 1)
    {
      ...
      $arr_solar = [ // 阳历节日
        '01-01'=>'元旦',
        '02-02'=>'湿地日','02-14'=>'情人节',
        '03-08'=>'妇女节','03-12'=>'植树节','03-15'=>'消费者权益日',
        '04-01'=>'愚人节','04-22'=>'地球日',
        '05-01'=>'劳动节','05-04'=>'五四青年节','05-18'=>'博物馆日',
        '06-01'=>'儿童节','06-05'=>'环境日','06-23'=>'奥林匹克日',
        '07-01'=>'建党节',
        '08-01'=>'建军节',
        '09-03'=>'抗战胜利日','09-10'=>'教师节',
        '10-01'=>'国庆节','10-20'=>'骨质疏松日','10-31'=>'万圣节',
        '11-17'=>'学生日',
        '12-01'=>'艾滋病日','12-13'=>'国家公祭日','12-24'=>'平安夜','12-25'=>'圣诞节'
      ];
    }
    $festivals = array();
    list($y,$m,$d) = explode('-',$today);
    if(!$nl_info) $nl_info = $this->convertSolarToLunar($today);
