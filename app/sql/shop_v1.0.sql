CREATE TABLE `ps_shop_merchant` (
  ...
  `scale` tinyint(4) NOT NULL DEFAULT '1' COMMENT '规模  1 0~5,2 5~10,3 10~20,4 20~50,5 50以上',
  `area` tinyint(4) NOT NULL DEFAULT '1' COMMENT '面积 1 10㎡以内,2 10~50㎡,3 50~100㎡,4 100㎡以上',
