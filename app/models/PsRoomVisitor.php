...
class PsRoomVisitor extends BaseModel
{
    ...
    {
        return [
            [['name', 'mobile', 'room_id', 'communityId', 'groupId', 'buildingId', 'unitId', 'fullName', 'user_id', 'member_id', 'visit_at'],'required','message'=>'{attribute}不能为空!','on' => ['add']],
