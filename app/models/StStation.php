...
class StStation extends BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['station'], 'string', 'max' => 15, 'tooLong' => '{attribute}不能超过15个字符!', 'message' => '{attribute}最多15个字！','on' => ['add', 'edit']],
            [['content'], 'string', 'max' => 50, 'tooLong' => '{attribute}不能超过50个字符!','message' => '{attribute}最多50个字！','on' => ['add', 'edit']],
