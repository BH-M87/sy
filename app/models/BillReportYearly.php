...
/**
 * This is the model class for table "bill_report_yearly".
 *
 * @property integer $id
 ...
 */
class BillReportYearly extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            //[['community_id', 'cost_id', 'year', 'bill_amount', 'bill_last', 'bill_history', 'bill_advanced', 'charge_amount', 'charge_discount', 'charge_last', 'charge_last_discount', 'charge_history', 'charge_history_discount', 'charge_advanced', 'charge_advanced_discount', 'nocharge_amount', 'nocharge_last', 'nocharge_history', 'create_at', 'update_at'], 'required'],
            //[['community_id', 'cost_id', 'create_at', 'update_at'], 'integer'],
